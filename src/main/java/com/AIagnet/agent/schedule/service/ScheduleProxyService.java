...
public class ScheduleProxyService {
    ...
    /**
     * 일정 챗봇 요청을 FastAPI로 전달.
     *
     * @param request 챗봇 요청
     * @return 챗봇 응답
     */
    public ScheduleChatResponse chat(ScheduleChatRequest request) {
        String url = fastApiUrl + "/api/agents/schedule/chat";
        ...
        try {
            ...
            ResponseEntity<ScheduleChatResponse> response = restTemplate.postForEntity(
                    url, httpEntity, ScheduleChatResponse.class);
